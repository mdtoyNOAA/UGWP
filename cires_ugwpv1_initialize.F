!>\file cires_ugwpv1_initialize.F
!!
...
!=========================================================================
    module ugwp_conv_init
     ...
     contains
!
     subroutine init_conv_gws(nwaves, nazdir, nstoch, effac, kxw)
!
...
!
     ...
     subroutine init_fjet_gws(nwaves, nazdir, nstoch, effac, kxw) 
...
!
     ...
     subroutine init_okw_gws(nwaves, nazdir, nstoch, effac, kxw)
     use ugwp_common,  only : pi2, arad
...
!
     ...
     subroutine initsolv_lsatdis(nwaves, nazdir, nstoch, effac, do_physb, kxw)
...
!
! copies from knob_ugwp namelist
!      
...
!
      contains
!============================================================================
     subroutine initsolv_wmsdis(nwaves, nazdir, nstoch, effac, do_physb, kxw, version)
...
!
!
     integer, intent(in)  :: nwaves, nazdir, nstoch
